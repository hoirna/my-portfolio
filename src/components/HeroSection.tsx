...
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Cloud SVGs */}
      <div
        className={`absolute mt-8 top-10 left-1/4 w-[500px] h-[400px] opacity-50 animate-clouds ${
          theme === "light" ? "fill-orange-500" : "fill-white"
        }`}
      >
        <svg
      ...
      <div
        className={`absolute mt-8 top-20 right-1/4 w-[250px] h-[150px] opacity-40 animate-clouds-2 ${
          theme === "light" ? "fill-orange-500" : "fill-white"
        }`}
      >
        <svg
      ...
      {/* Additional Cloud 1 (Fast) */}
      <div
        className={`absolute top-16 left-1/3 w-[300px] h-[150px] opacity-50 animate-clouds-3 ${
          theme === "light" ? "fill-orange-500" : "fill-white"
        }`}
      >
        <svg
      ...
      {/* Additional Cloud 2 (Slow) */}
      <div
        className={`absolute top-24 left-1/2 w-[350px] h-[170px] opacity-60 animate-clouds-4 ${
          theme === "light" ? "fill-orange-500" : "fill-white"
        }`}
      >
        <svg
      ...
      <div className="absolute top-0 mx-24 mt-24 left-0 flex justify-center items-center opacity-100 spin">
        {theme === "dark" ? (
